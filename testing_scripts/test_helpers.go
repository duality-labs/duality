...
func SingleLimitOrderFillAndUpdate(amount_placed sdk.Int,
	...
	unfilled_reserves sdk.Int) (sdk.Int, sdk.Int, sdk.Int) {
...
func MultipleLimitOrderFills(amounts_placed []sdk.Int, prices []sdk.Dec, amount_to_swap sdk.Int) sdk.Int {
	total_out, amount_remaining := sdk.ZeroInt(), amount_to_swap
...
func SinglePoolSwapAndUpdate(amount_liquidity sdk.Int,
	...
	reservesOfOutToken sdk.Int) (sdk.Int, sdk.Int, sdk.Int, sdk.Int) {
...
func SinglePoolSwapAndUpdateDirectional(amount_liquidity sdk.Int,
	...
	inToken bool) (sdk.Int, sdk.Int) {
	resultingReservesOfToken0, resultingReservesOfToken1 := sdk.ZeroInt(), sdk.ZeroInt()
	if inToken {
...
func MultiplePoolSwapAndUpdate(amounts_liquidity []sdk.Int,
	...
	reserves_out_token_array []sdk.Int) ([]sdk.Int, []sdk.Int, sdk.Int, sdk.Int) {
	num_pools := len(amounts_liquidity)
	amount_remaining := amount_to_swap
	amount_out_total, amount_out_temp, amount_in := sdk.ZeroInt(), sdk.ZeroInt(), sdk.ZeroInt()
	resulting_reserves_in_token := make([]sdk.Int, num_pools, num_pools)
	resulting_reserves_out_token := make([]sdk.Int, num_pools, num_pools)
