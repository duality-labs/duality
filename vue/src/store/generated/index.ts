...
import NicholasDotSolDualityNicholasdotsolDualityRouter from './NicholasDotSol/duality/nicholasdotsol.duality.router'
...
export default { 
  ...
  NicholasDotSolDualityNicholasdotsolDualityRouter: load(NicholasDotSolDualityNicholasdotsolDualityRouter, 'nicholasdotsol.duality.router'),
