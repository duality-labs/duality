...
export interface VirtualPriceQueueType {
  price: string;
  fee: string;
  orderparams: OrderParams | undefined;
}

const baseVirtualPriceQueueType: object = { price: "", fee: "" };

export const VirtualPriceQueueType = {
  encode(
    message: VirtualPriceQueueType,
  ...
  decode(input: Reader | Uint8Array, length?: number): VirtualPriceQueueType {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseVirtualPriceQueueType } as VirtualPriceQueueType;
  ...
  fromJSON(object: any): VirtualPriceQueueType {
    const message = { ...baseVirtualPriceQueueType } as VirtualPriceQueueType;
  ...
  toJSON(message: VirtualPriceQueueType): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<VirtualPriceQueueType>
  ): VirtualPriceQueueType {
    const message = { ...baseVirtualPriceQueueType } as VirtualPriceQueueType;
    if (object.price !== undefined && object.price !== null) {
