...
class MsgStub(betterproto.ServiceStub):
    async def submit_proposal(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Msg/SubmitProposal", request, MsgSubmitProposalResponse
        )
    ...
    async def vote(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Msg/Vote", request, MsgVoteResponse
        )
    ...
    async def vote_weighted(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Msg/VoteWeighted", request, MsgVoteWeightedResponse
        )
    ...
    async def deposit(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Msg/Deposit", request, MsgDepositResponse
        )
...
class QueryStub(betterproto.ServiceStub):
    async def proposal(self, *, proposal_id: int = 0) -> "QueryProposalResponse":
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Proposal", request, QueryProposalResponse
        )
    ...
    async def proposals(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Proposals", request, QueryProposalsResponse
        )
    ...
    async def vote(
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Vote", request, QueryVoteResponse
        )
    ...
    async def votes(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Votes", request, QueryVotesResponse
        )
    ...
    async def params(self, *, params_type: str = "") -> "QueryParamsResponse":
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Params", request, QueryParamsResponse
        )
    ...
    async def deposit(
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Deposit", request, QueryDepositResponse
        )
    ...
    async def deposits(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/Deposits", request, QueryDepositsResponse
        )
    ...
    async def tally_result(self, *, proposal_id: int = 0) -> "QueryTallyResultResponse":
        ...
        return await self._unary_unary(
            "/cosmos.gov.v1.Query/TallyResult", request, QueryTallyResultResponse
        )
...
class MsgBase(ServiceBase):
    ...
    async def exec_legacy_content(
        self, content: "betterproto_lib_google_protobuf.Any", authority: str
    ) -> "MsgExecLegacyContentResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def vote(
        self, proposal_id: int, voter: str, option: "VoteOption", metadata: str
    ) -> "MsgVoteResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_exec_legacy_content(self, stream: grpclib.server.Stream) -> None:
        request = await stream.recv_message()
        ...
        response = await self.exec_legacy_content(**request_kwargs)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.gov.v1.Msg/SubmitProposal": grpclib.const.Handler(
                self.__rpc_submit_proposal,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgSubmitProposal,
                MsgSubmitProposalResponse,
            ),
            "/cosmos.gov.v1.Msg/ExecLegacyContent": grpclib.const.Handler(
                self.__rpc_exec_legacy_content,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgExecLegacyContent,
                MsgExecLegacyContentResponse,
            ),
            "/cosmos.gov.v1.Msg/Vote": grpclib.const.Handler(
                self.__rpc_vote,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgVote,
                MsgVoteResponse,
            ),
            "/cosmos.gov.v1.Msg/VoteWeighted": grpclib.const.Handler(
                self.__rpc_vote_weighted,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgVoteWeighted,
                MsgVoteWeightedResponse,
            ),
            "/cosmos.gov.v1.Msg/Deposit": grpclib.const.Handler(
                self.__rpc_deposit,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgDeposit,
                MsgDepositResponse,
