...
class QueryStub(betterproto.ServiceStub):
    ...
    async def denom_owners(
        ...
        *,
        ...
        return await self._unary_unary(
            "/cosmos.bank.v1beta1.Query/DenomOwners", request, QueryDenomOwnersResponse
        )
...
class QueryBase(ServiceBase):
    ...
    async def denom_owners(
        self, denom: str, pagination: "__base_query_v1_beta1__.PageRequest"
    ) -> "QueryDenomOwnersResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_denom_owners(self, stream: grpclib.server.Stream) -> None:
        request = await stream.recv_message()
        ...
        response = await self.denom_owners(**request_kwargs)
        await stream.send_message(response)
