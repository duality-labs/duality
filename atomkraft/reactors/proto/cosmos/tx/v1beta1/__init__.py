...
class SignDocDirectAux(betterproto.Message):
    ...
    # Tip is the optional tip used for meta-transactions. It should be left empty
    # if the signer is not the tipper for this transaction.
...
class AuthInfo(betterproto.Message):
    ...
    # Tip is the optional tip used for meta-transactions. Since: cosmos-sdk 0.46
