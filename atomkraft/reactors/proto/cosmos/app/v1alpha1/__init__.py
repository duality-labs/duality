...
class ModuleDescriptor(betterproto.Message):
    ...
    # module in the runtime module registry. Either go_import must be defined
    # here or the go_package option must be defined at the file level to indicate
...
class PackageReference(betterproto.Message):
    ...
    # comment above the package declaration in one of its fields containing the
    # test "Revision N" where N is an integer revision. All packages start at
...
class QueryStub(betterproto.ServiceStub):
    async def config(self) -> "QueryConfigResponse":
        ...
        return await self._unary_unary(
            "/cosmos.app.v1alpha1.Query/Config", request, QueryConfigResponse
        )
