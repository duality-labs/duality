...
const (
	LockStatus_ALL           LockStatus = 0
	LockStatus_UNLOCKING     LockStatus = 1
	LockStatus_NOT_UNLOCKING LockStatus = 2
)
...
type GetStakesRequest struct {
	Status     LockStatus         `protobuf:"varint,1,opt,name=status,proto3,enum=duality.incentives.LockStatus" json:"status,omitempty"`
...
func (m *GetStakesRequest) GetStatus() LockStatus {
	if m != nil {
		return m.Status
	}
	return LockStatus_ALL
}
...
func init() {
	...
	proto.RegisterEnum("duality.incentives.LockStatus", LockStatus_name, LockStatus_value)
...
var fileDescriptor_27b4715672276428 = []byte{
	...
	,
}
