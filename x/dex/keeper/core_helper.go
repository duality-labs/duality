...
func InitLiquidityToken0(p types.TradingPair, tickIndex int64) types.TradingPair {
	minTick := &p.MinTick
...
func InitLiquidityToken1(p types.TradingPair, tickIndex int64) types.TradingPair {
	maxTick := &p.MaxTick
