...
func CreateSharesId(denom0 string, denom1 string, tickIndex int64, feeIndex uint64) (denom string) {
	return fmt.Sprintf("%s%s%d%d", denom0, denom1, tickIndex, feeIndex)
}
