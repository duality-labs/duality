...
func (s *MsgServerTestSuite) TestSwapExhaustFeeTiersAndLimitOrder() {
	...
	s.assertLimitLiquidityAtTick("TokenB", sdk.NewDec(10).Sub(amountOutSetup), 1)
	...
	s.assertLimitLiquidityAtTick("TokenB", limitLiquiditySetup, 1)
	...
	s.assertLimitLiquidityAtTick("TokenB", sdk.ZeroDec(), 1)
}
