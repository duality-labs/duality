...
func (s *CoreHelpersTestSuite) TestFindNextTick1To0NoLiq() {
	...
	_, found := s.app.DexKeeper.GetCurrTick(s.ctx, defaultTradePairID1To0)
...
func (s *CoreHelpersTestSuite) TestGetCurrTick1To0WithLiq() {
	...
	tickIdx, found := s.app.DexKeeper.GetCurrTick(s.ctx, defaultTradePairID1To0)
...
func (s *CoreHelpersTestSuite) TestGetCurrTick0To1NoLiq() {
	...
	_, found := s.app.DexKeeper.GetCurrTick(s.ctx, defaultTradePairID0To1)
	s.Assert().False(found)
}
...
func (s *CoreHelpersTestSuite) TestGetCurrTick0To1WithLiq() {
	...
	tickIdx, found := s.app.DexKeeper.GetCurrTick(s.ctx, defaultTradePairID0To1)
	s.Require().True(found)
	s.Assert().Equal(int64(1), tickIdx)
}
