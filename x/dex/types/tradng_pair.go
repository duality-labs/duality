...
type TradingPairI interface {
	InitLiquidity(tickIndex int64) TradingPair
	DeinitLiquidity(tickIndex int64) TradingPair
}
...
type DirectionalTradingPair struct {
	PairId          string
	CurrentTick0To1 int64
	CurrentTick1To0 int64
	MaxTick         int64
	MinTick         int64
	Is0To1          bool
}

func NewDirectionalTradingPair(p TradingPair, is0To1 bool) DirectionalTradingPair {
	return DirectionalTradingPair{
		PairId:          p.PairId,
		CurrentTick0To1: p.CurrentTick0To1,
		CurrentTick1To0: p.CurrentTick1To0,
		MaxTick:         p.MaxTick,
		MinTick:         p.MinTick,
		Is0To1:          is0To1,
	}
...
func (p TradingPair) DeinitLiquidity(ctx context.Context, k keeper.Keeper, tickIndex int64, removingToken0 bool) {
	if removingToken0 {
...
func (p TradingPair) DeinitLiquidityToken0(ctx context.Context, k keeper.Keeper, tickIndex int64) {
	minTick := &p.MinTick
...
func (p TradingPair) DeinitLiquidityToken1(ctx context.Context, k keeper.Keeper, tickIndex int64) {
	maxTick := &p.MaxTick
