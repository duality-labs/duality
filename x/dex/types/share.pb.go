...
type Share struct {
	...
	ShareAmount uint64 `protobuf:"varint,6,opt,name=shareAmount,proto3" json:"shareAmount,omitempty"`
}
...
func (m *Share) GetShareAmount() uint64 {
	if m != nil {
...
var fileDescriptor_e8aac87fd5ccb63b = []byte{
	...
	,
	...
	0xfd, 0xa0, 0x5e, 0x73, 0xc9, 0x2f, 0x09, 0xce, 0xcf, 0xd1, 0x87, 0x7a, 0x4d, 0xbf, 0x42, 0x1f,
	0x14, 0x08, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0x50, 0x30, 0x06, 0x04, 0x00, 0x00,
	0xff, 0xff, 0x23, 0x63, 0xd2, 0x50, 0x18, 0x01, 0x00, 0x00,
}
...
func (m *Share) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ShareAmount != 0 {
		i = encodeVarintShare(dAtA, i, uint64(m.ShareAmount))
		i--
		dAtA[i] = 0x30
	}
	if m.Fee != 0 {
		i = encodeVarintShare(dAtA, i, uint64(m.Fee))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Price) > 0 {
...
func (m *Share) Size() (n int) {
	...
	if m.Fee != 0 {
		n += 1 + sovShare(uint64(m.Fee))
	}
	if m.ShareAmount != 0 {
		n += 1 + sovShare(uint64(m.ShareAmount))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ShareAmount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
