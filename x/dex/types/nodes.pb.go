...
var fileDescriptor_df7c99d9da136ca0 = []byte{
	...
	0xc0, 0x92, 0xa8, 0x82, 0x4e, 0xee, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0,
	0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78, 0x2c, 0xc7, 0x10,
	0xa5, 0x9b, 0x9e, 0x59, 0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0xef, 0x07, 0x75, 0x83,
	0x4b, 0x7e, 0x49, 0x70, 0x7e, 0x8e, 0x3e, 0xd4, 0x0d, 0xfa, 0x15, 0xfa, 0x20, 0xd7, 0x96, 0x54,
	0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x9d, 0x6b, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb8, 0xdd,
	0x41, 0xcb, 0xc1, 0x00, 0x00, 0x00,
}
...
func (m *Nodes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OutgoingEdges) > 0 {
		...
		i = encodeVarintNodes(dAtA, i, uint64(len(m.OutgoingEdges)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Node) > 0 {
