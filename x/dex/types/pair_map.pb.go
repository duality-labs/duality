...
type PairMap struct {
	...
	PairCount int64          `protobuf:"varint,3,opt,name=pairCount,proto3" json:"pairCount,omitempty"`
}
...
func (m *PairMap) GetPairCount() int64 {
	if m != nil {
		return m.PairCount
	}
	return 0
...
var fileDescriptor_11ff39a06df8ef0c = []byte{
	...
	,
}
...
func (m *PairMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PairCount != 0 {
		i = encodeVarintPairMap(dAtA, i, uint64(m.PairCount))
		i--
		dAtA[i] = 0x18
	}
	if m.TokenPair != nil {
...
func (m *PairMap) Size() (n int) {
	...
	if m.PairCount != 0 {
		n += 1 + sovPairMap(uint64(m.PairCount))
	}
	return n
}
...
func (m *PairMap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PairCount", wireType)
			}
			m.PairCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PairCount |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
