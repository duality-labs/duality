...
func NewMsgAddLiquidity(creator string, tokenA string, tokenB string, tokenDirection string, amount string, price string, fee string, orderType string) *MsgAddLiquidity {
