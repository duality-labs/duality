...
var (
	...
	ErrNegativeMaxAmountOut               = sdkerrors.Register(ModuleName, 1144, "MAxAmountOut must be > 0")
	ErrInvalidOrderTypeForMaxAmountOut    = sdkerrors.Register(ModuleName, 1145, "Max amount out can only be used on IoC or Fok limit orders")
)
