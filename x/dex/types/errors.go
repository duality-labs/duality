...
var (
	...
	ErrInvalidNumChunks            = sdkerrors.Register(ModuleName, 1112, "Invalid Number of Chunks (Router): %s")
	ErrValidLimitOrderMapsNotFound = sdkerrors.Register(ModuleName, 1113, "Limit Order Mappings not found")
	ErrCannotWithdrawLimitOrder    = sdkerrors.Register(ModuleName, 1114, "Cannot withdraw additional liqudity from this limit order at this time")
)
