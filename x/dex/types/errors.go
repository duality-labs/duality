...
var (
	...
	ErrInvalidDepositDenom                = sdkerrors.Register(ModuleName, 1118, "Denom is not an instance of Duality DepositDenom")
	...
	ErrZeroSwap                           = sdkerrors.Register(ModuleName, 1125, "MaxAmountIn in must be > 0 for swap.")
	...
	ErrFoKLimitOrderNotFilled             = sdkerrors.Register(ModuleName, 1134, "Fill Or Kill limit order couldn't be executed in its entirety.")
	...
	ErrExitLimitPriceHit                  = sdkerrors.Register(ModuleName, 1140, "ExitLimitPrice cannot be satisfied.")
	...
	ErrZeroMaxAmountOut                   = sdkerrors.Register(ModuleName, 1144, "MaxAmountOut must be nil or > 0.")
	ErrInvalidMaxAmountOutForMaker        = sdkerrors.Register(ModuleName, 1145, "MaxAmountOut can only be set for taker only limit orders.")
)
