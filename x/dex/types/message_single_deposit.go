...
func NewMsgSingleDeposit(creator string, token0 string, token1 string, price string, fee string, amounts0 string, amounts1 string, receiver string) *MsgSingleDeposit {
