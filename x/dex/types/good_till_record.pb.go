...
type GoodTillRecord struct {
	...
	GoodTilllDate *time.Time `protobuf:"bytes,1,opt,name=GoodTilllDate,proto3,stdtime" json:"GoodTilllDate,omitempty"`
	TrancheRef    string     `protobuf:"bytes,2,opt,name=trancheRef,proto3" json:"trancheRef,omitempty"`
}
...
func (m *GoodTillRecord) GetGoodTilllDate() *time.Time {
	if m != nil {
		return m.GoodTilllDate
	}
	return nil
}

func (m *GoodTillRecord) GetTrancheRef() string {
	if m != nil {
		return m.TrancheRef
	}
	return ""
...
var fileDescriptor_33f0c5e2cff15201 = []byte{
	...
	,
}
...
func (m *GoodTillRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GoodTilllDate != nil {
		n1, err1 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.GoodTilllDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.GoodTilllDate):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *GoodTillRecord) Size() (n int) {
	...
	_ = l
	if m.GoodTilllDate != nil {
		l = github_com_gogo_protobuf_types.SizeOfStdTime(*m.GoodTilllDate)
...
func (m *GoodTillRecord) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GoodTilllDate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GoodTilllDate == nil {
				m.GoodTilllDate = new(time.Time)
			}
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(m.GoodTilllDate, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.TrancheRef = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
