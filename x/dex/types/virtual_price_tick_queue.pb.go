...
func (m *VirtualPriceTickQueue) GetPrice() string {
	if m != nil {
		return m.Price
	}
	return ""
...
func (m *VirtualPriceTickQueue) GetFee() string {
	if m != nil {
		return m.Fee
	}
	return ""
...
var fileDescriptor_6a2b863c12d9ee71 = []byte{
	...
	,
	...
	0x73, 0xf5, 0xfd, 0xa0, 0xee, 0x75, 0xc9, 0x2f, 0x09, 0xce, 0xcf, 0xd1, 0x87, 0xba, 0x57, 0xbf,
	0x42, 0x1f, 0xe4, 0xd9, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0xd7, 0x8c, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0x1b, 0xac, 0x30, 0x8d, 0x00, 0x01, 0x00, 0x00,
}
...
func (m *VirtualPriceTickQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Fee) > 0 {
		i -= len(m.Fee)
		copy(dAtA[i:], m.Fee)
		i = encodeVarintVirtualPriceTickQueue(dAtA, i, uint64(len(m.Fee)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Price) > 0 {
		i -= len(m.Price)
		copy(dAtA[i:], m.Price)
		i = encodeVarintVirtualPriceTickQueue(dAtA, i, uint64(len(m.Price)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
