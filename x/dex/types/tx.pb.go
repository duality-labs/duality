...
type MsgDeposit struct {
	...
	PriceIndex int64  `protobuf:"varint,6,opt,name=priceIndex,proto3" json:"priceIndex,omitempty"`
...
func (m *MsgDeposit) GetPriceIndex() int64 {
	if m != nil {
		return m.PriceIndex
	}
	return 0
...
type MsgWithdrawl struct {
	...
	PriceIndex     int64  `protobuf:"varint,5,opt,name=priceIndex,proto3" json:"priceIndex,omitempty"`
...
type MsgSwap struct {
	...
	SlippageToleranceIndex int64  `protobuf:"varint,7,opt,name=slippageToleranceIndex,proto3" json:"slippageToleranceIndex,omitempty"`
}
...
func (m *MsgSwap) GetSlippageToleranceIndex() int64 {
	if m != nil {
		return m.SlippageToleranceIndex
	}
	return 0
}
...
var fileDescriptor_463701e671e5a5e0 = []byte{
	...
	,
}
...
func (m *MsgDeposit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PriceIndex != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.PriceIndex))
		i--
		dAtA[i] = 0x30
	}
	if len(m.AmountB) > 0 {
...
func (m *MsgSwap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SlippageToleranceIndex != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.SlippageToleranceIndex))
		i--
		dAtA[i] = 0x38
	}
	if len(m.MinOut) > 0 {
...
func (m *MsgSwap) Size() (n int) {
	...
	if m.SlippageToleranceIndex != 0 {
		n += 1 + sovTx(uint64(m.SlippageToleranceIndex))
	}
	return n
}
...
func (m *MsgSwap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlippageToleranceIndex", wireType)
			}
			m.SlippageToleranceIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SlippageToleranceIndex |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
