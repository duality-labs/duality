...
type MsgWithdrawFilledLimitOrder struct {
	...
	TrancheKey uint64 `protobuf:"varint,7,opt,name=trancheKey,proto3" json:"trancheKey,omitempty"`
}
...
func (m *MsgWithdrawFilledLimitOrder) GetTrancheKey() uint64 {
	if m != nil {
		return m.TrancheKey
	}
	return 0
...
func (m *MsgCancelLimitOrder) GetTrancheKey() uint64 {
	if m != nil {
		return m.TrancheKey
	}
	return 0
...
var fileDescriptor_0012bae7d4530cbb = []byte{
	...
	,
}
...
func (m *MsgWithdrawFilledLimitOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TrancheKey != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.TrancheKey))
		i--
		dAtA[i] = 0x38
	}
	if len(m.KeyToken) > 0 {
