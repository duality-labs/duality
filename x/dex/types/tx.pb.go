...
type MsgPlaceLimitOrder struct {
	...
	GoodTil   *time.Time                             `protobuf:"bytes,9,opt,name=GoodTil,proto3,stdtime" json:"GoodTil,omitempty"`
}
...
func (m *MsgPlaceLimitOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GoodTil != nil {
		n10, err10 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.GoodTil, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.GoodTil):])
		if err10 != nil {
			return 0, err10
		}
		i -= n10
...
func (m *MsgPlaceLimitOrder) Size() (n int) {
	...
	if m.GoodTil != nil {
		l = github_com_gogo_protobuf_types.SizeOfStdTime(*m.GoodTil)
		n += 1 + l + sovTx(uint64(l))
	}
	return n
}
...
func (m *MsgPlaceLimitOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.GoodTil == nil {
				m.GoodTil = new(time.Time)
			}
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(m.GoodTil, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
