...
func CreateMinimalConsumerTestGenesis() *ccvconsumertypes.GenesisState {
	...
	genesisState.ProviderClientState.LatestHeight = ibctypes.Height{
		RevisionNumber: 0,
		RevisionHeight: 1,
	}
	genesisState.ProviderClientState.TrustingPeriod, _ = typesccv.CalculateTrustPeriod(
		genesisState.Params.UnbondingPeriod,
		ccvprovidertypes.DefaultTrustingPeriodFraction,
	)
