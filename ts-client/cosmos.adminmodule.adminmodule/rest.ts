...
export type AdminmoduleMsgAddAdminResponse = object;
...
export interface AdminmoduleQueryAdminsResponse {
  admins?: string[];
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmos/adminmodule/adminmodule/admins
   */
  queryAdmins = (params: RequestParams = {}) =>
    this.request<AdminmoduleQueryAdminsResponse, RpcStatus>({
      path: `/cosmos/adminmodule/adminmodule/admins`,
      method: "GET",
      format: "json",
      ...params,
    });
